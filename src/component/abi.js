...
const config = {
    name: "SWAP",
    contractAddress: "3V1HBTGg8F48wMGuz91BqHd7eTQVauppXsysNoFtt5ssDaymXxnnexAHLpjpkLvJXLxS34avbkwo6mjuYBSQ2Kmp",
...
const contract = serojs.callContract(abiJson, "mcLeHCkWfoUBTLH1FskrKnoaxUSToY2U7sPiX93Qjijc5nRQ8bZghUE75caRYsQ2RvAM17KhXDYn7AUiQtmo4Kk");
...
class Abi {
    ...
    feeRate(from, tokenA, tokenB, callback) {
        let key = hashKey(tokenA, tokenB);
        this.callMethod(contract, 'feeRate', from, [key], function (ret) {
            callback(Number(ret[0]));
        });
    }
